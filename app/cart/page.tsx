      ...
      <section className="pb-16">
        <div className="container mx-auto px-4 md:px-12 py-7 bg-[#F0FAF7] flex md:flex-row flex-col gap-4 items-center justify-between md:mb-20 mb-16">
          <h3 className="md:text-xl text-xs font-bold text-title font-DM_Sans capitalize">
            Dark Grey Wood Grain Composite Decking Board – Essential Collection
        ...
        <div className="container mx-auto px-4">
          ...
          {items.length === 0 ? (
            <div>
              <p className="md:text-lg text-xs font-bold text-title font-DM_Sans capitalize">
                Your cart is empty.
              </p>
            </div>
          ) : (
              ...
              <div className="md:w-1/3 w-full bg-[#F6F6F654] border border-[#E4E4E4] px-6 py-8 flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex flex-col border-b border-[#D2D2D2] md:py-10 py-8 space-y-4">
                    ...
                    <p className="text-sm font-normal text-description font-Satoshi">
                      <strong>Please note: </strong> additional delivery charges
                      could be incurred for Highlands and Islands. We will
                      contact you to arrange before delivery.
                    </p>
                    <p className="text-sm font-normal text-description font-Satoshi">
                ...
                <Link
                  href="/checkout"
                  className="inline-flex items-center justify-center w-full bg-secondary text-white rounded-full px-6 py-3 font-bold hover:bg-primary transition-all"
                >
                  Proceed To Checkout
                </Link>
              </div>
